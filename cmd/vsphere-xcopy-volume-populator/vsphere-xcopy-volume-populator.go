...
func handleArgs() {
	...
	flag.StringVar(&storageVendor, "storage-vendor", "primera3par", "The storage vendor to work with. Current values: [ontap, primera3par]")
	...
	flag.StringVar(&storageSkipSSLVerification, "storage-skip-ssl-verification", "true", "skip the storage ssl verification")
