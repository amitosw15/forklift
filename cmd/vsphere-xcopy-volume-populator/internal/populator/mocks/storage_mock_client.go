...
//
//	mockgen -destination=mocks/storage_mock_client.go -package=storage . StorageApi
//
...
func (m *MockStorageApi) Map(initatorGroup string, targetLUN populator.LUN) (populator.LUN, error) {
	m.ctrl.T.Helper()
