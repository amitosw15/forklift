...
func init() {
	...
	createTestCmd.Flags().StringVar(&vmdkPath, "vmdk-path", "cr.yaml", "Path to the CR instance YAML file")
	createTestCmd.Flags().StringVar(&storageVendor, "storage-vendor", "cr.yaml", "Path to the CR instance YAML file")
}
