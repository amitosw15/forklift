...
func NewHpeImporter(host, user, pass string, skipSSL bool) (*HpeImporter, error) {
	// host must be a full URL with scheme and port (e.g. "https://10.46.2.10:8080"),
	// matching the STORAGE_HOSTNAME format expected by the xcopy populator.
...
// BackingObjectId format: "vvol:<uuid>" — the UUID matches HPE WSAPI volume.uuid.
